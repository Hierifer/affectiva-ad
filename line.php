...
var color = d3.scale.ordinal().range(["#64B98C", "#7FC9BD" , "#7FB1CF", "#AA81C5",  "#D3779F",  "#E16167", "#E38457"]);
...
d3.tsv(<?php echo $fileName?>, function(error, data) { 
  ...
  var categories = color.domain().map(function(name) { // Nest the data into an array of objects with new keys
    ...
    return {
      ...
      visible: (name === "Fear" ? true : false) // "visible": all false except for economy which is true.
    };
  });
